...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body>
        ...
        <div class="top-content" style="position: relative; z-index: 0; background: none;">
        	...
        	<!-- Top menu -->
			<nav class="navbar navbar-inverse" role="navigation" style="background-color:#004A6E;">
				<div class="container">
	        ...
	        <div class="container">
	            ...
	            <div class="row">
					...
					<div class="col-sm-4 features-box features-box-gray wow fadeInUp" style="visibility: hidden; animation-name: none;">
	                    ...
	                    <h3>Get connected</h3>
	                    <p>Don't be left behind, Stay connected to the market, we keep you updated to your favourite companies. Be the first one to know when they make specials. Get access to all the companies</p>
                    </div>
	            ...
	            <div class="row">
                	<div class="col-sm-4 features-box wow fadeInUp" style="visibility: hidden; animation-name: none;">
	                    ...
	                    <h3>Sell online</h3>
	                    <p>Are you a startup merchant? or A large Enterprise? either way growth isn't a bad idea. Lets get you started by putting your store and your products online with no worries about the IT infrastructure and capabilities to archive this. We carry that burden </p>
                    </div>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
                	<div class="col-sm-4 col-sm-offset-1 how-it-works-box wow fadeInUp" style="visibility: hidden; animation-name: none;">
	                    ...
	                    <p><b><i>Yes its free and easy, we won't take much of your time to get you registered</i></b></p>
                    </div>
